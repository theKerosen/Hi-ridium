...
export = {
  ...
  async execute(interaction, client) {
    ...
    const menu = new BStringMenu()
      .createStringMenu({custom_id: "report", placeholder: "► Selecione o tipo da denúncia..."})
      .setOptions([
        { label: "Provocações indesejadas", value: "provocação" },
    ...
    const embed = new BEmbed().setADC({
      ...
      description: `O usuário denunciado será "\`${reportedUser?.username}\`"\n por favor, selecione o motivo abaixo.`,
      color: "Blurple",
    });
